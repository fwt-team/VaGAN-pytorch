...
@File: test_smm_v2.py
@Time: 2020-01-31 14:57
@Desc: test for VaGAN-SMM
"""
try:
    import os
    import argparse
    ...
    from vagan.studentT_model_v2 import Generator, SMM, Encoder
    from vagan.utils import cluster_acc
...
def main():
    ...
    parser.add_argument("-s", "--dataset_name", dest="dataset_name", default='mnist', choices=dataset_list,
                        help="Dataset name")
    parser.add_argument("-v", "--version_name", dest="version_name", default="SMM_V2")
    ...
    smm.load_state_dict(torch.load(os.path.join(models_dir, "smm.pkl"), map_location=DEVICE))
